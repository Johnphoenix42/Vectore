...
public class CircleButtonTool extends DrawableButtonTool {
    ...
    private final Logger circleButtonLogger = Logger.getLogger(getClass().getName());
    ...
    private Circle createAnchorPoint(double x, double y, int anchorCounter, Map<String, LinkedHashMap<String, Node>> renderTree) {
        ...
        anchor.setOnMouseDragged(event -> {
            if(isDrawing){
                ...
                circleButtonLogger.log(Level.SEVERE, "Drag not Executing");
                return;
            }
            ...
            if (anchorCounter == 0) {
                ...
                anchor2.setCenterX(eventX - radiusVector.x());
                anchor2.setCenterY(eventY - radiusVector.y());
            } else {
